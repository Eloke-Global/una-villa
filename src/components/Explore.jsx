...
const Explore = () => {
  return (
    <div className="w-full bg-primary">
        <div className="w-[1145px] mx-auto">
            <div className="h-2.5 border-y border-black"></div>
            <div className="pt-[78px] pb-[116px]">
                <div className="flex flex-col text-center">
                    <div className="text-[22px] merri font-bold">
                        EXPLORE THE CRAFTMENSHIP
                    </div>
                    <div className="text-justify pb-[78px] pt-6 iplex text-lg">

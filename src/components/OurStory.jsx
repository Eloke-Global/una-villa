...
const OurStory = () => {
  return (
    <div className="w-full pt-[25px] lg:pt-[50px] bg-primary" id = "ourstory">
        <div className="lg:max-w-[1145px] max-w-[375px] lg:p-0 px-5 mx-auto">
            <div className="hidden lg:block h-full tracking-[10px] mb-[50px] merri-bold text-center pb-[50px] border-b border-prim-darkGray">
                OUR STORY
            </div>
            <div className="w-full flex flex-col lg:flex-row lg:items-center lg:gap-9 gap-[25px] ">
                ...
                <div className="w-full text-xs lg:text-base iplex flex-1 flex flex-col lg:gap-2">
                    <div className="text-xs pb-[25px] merri-bold tracking-[4px] mb-[25px] border-b border-prim-darkGray lg:hidden text-center">
                        OUR STORY
                    </div>
                    {/* <div className="merri-bold text-[16px] pb-6 lg:pb-2">OUR STORY</div> */}
                    <div className=" lg:tracking-[1.5px] tracking-[2px]  pb-2">

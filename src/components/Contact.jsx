  ...
  return (
    <div className="w-full bg-primary">
        <div className="lg:max-w-[1145px] max-w-[375px] px-5 lg:p-0 mx-auto">
            <div className="flex gap-9 lg:gap-20 flex-col items-center lg:pt-20 py-11 lg:pb-32">
                ...
                <div className="flex lg:flex-row flex-col gap-10 w-full">
                    ...
                    <div className="flex-1 flex gap-4">
                        <div className="merri-italic text-[16px] lg:text-[22px] flex-1 text-center lg:h-[215px] border flex-col p-4 py-5 lg:py-0 border-black flex items-center gap-2 justify-center">
                            Contact
                            <div className="iplex text-xs lg:text-lg">
                                Call us on +91 xxxxx xxxxx or write to us at xyz@xyz.com
                            </div>
                        </div>
                        <div className="merri-italic text-[16px] lg:text-[22px]  flex-1 text-center lg:h-[215px] border flex-col p-4 border-black flex items-center gap-2 justify-center">
                            Hours
            ...
            <div className="lg:h-2.5 h-1 border-y border-black"></div>
        </div>
    </div>
  )
}

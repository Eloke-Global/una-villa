...
const Gallery = () => {
  return (
    <div className="bg-primary w-full" id = "gallery">
        <div className="mx-auto w-full max-w-[345px] lg:max-w-[1145px] lg:py-[50px] py-[25px]">
            <div className="merri-bold uppercase tracking-[10px] text-center lg:text-base text-xs">
                Gallery
            </div>
            <div className="h-[1px] bg-prim-darkGray my-[25px] lg:my-[50px]"></div>
            ...
            <div className="lg:flex lg:flex-row hidden px-4 pt-[25px] lg:pt-[50px] gap-6">

  ...
  return (
    <div className="bg-primary pt-[43px] pb-[53px] lg:pb-52 lg:pt-24">
        <div className="lg:max-w-[1145px] max-w-[375px] p-5 mx-auto flex lg:flex-row flex-col-reverse gap-[43px] lg:gap-28">
            <div className="flex-1 w-[336px] lg:h-[450px] border border-prim-darkGray p-2">
            ...
            <div className="flex-1 flex gap-[20px] text-[16px] lg:gap-16 flex-col justify-center merri">
                ...
                <button className="bg-[#2E6E76] max-w-fit px-20 lg:px-10 iplex-italic italic text-lg text-primary underline py-2 relative ">

          ...
          <div className="h-screen flex lg:hidden bg-primary z-[1000] absolute top-0 left-0 w-screen ">
            <div className="relative flex h-full w-full justify-between items-center flex-col bg-primary pt-16 pb-12">
              ...
              <div className=" flex flex-col bg-black gap-[1px] border-y border-black w-full merri-bold uppercase">
                <button href = "#top" className="h-[75px] w-full bg-primary uppercase">
                    <a href="#top">
                        Home
                    </a>
                </button>
                <button href = "#ourstory" className="h-[75px] w-full bg-primary uppercase">
                    <a href="#ourstory">
                        About Us
                    </a>
                </button>
                <button href = "#menu" className="h-[75px] w-full bg-primary uppercase">
                    <a href="#menu">
                        Menu
                    </a>
                </button>
                <button href = "#gallery" className="h-[75px] w-full bg-primary uppercase">
                    <a href="#gallery">
                        Gallery
                    </a>
                </button>
                <button href = "#contact" className="h-[75px] w-full bg-primary uppercase">
                    <a href="#contact">
                        Contact
                    </a>
                </button>
